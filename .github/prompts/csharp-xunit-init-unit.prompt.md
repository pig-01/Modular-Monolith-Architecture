---
mode: 'agent'
tools: ['changes', 'codebase', 'editFiles', 'findTestFiles', 'problems', 'runCommands', 'runTests', 'search', 'searchResults', 'terminalSelection', 'testFailure']
description: 'Get best practices for XUnit unit testing, including data-driven tests and test execution'
---

# XUnit Unit Testing Best Practices 
...
I will give you a csharp file that contains the code I want to test, and you will help me create unit tests for it using XUnit.
...
- **Test Project Root**: The root directory of the test project (e.g., `/test/ProjectName.Tests`)
...
- **Test Document Template**: [Test Document Template](.github/templates/csharp-xunit-document.template.md)
- **Test Document**: The document that describes the tests and their purpose (e.g., `CalculatorTests.TestDoc.md`)
...
- **Template Location**: [Test Document Template](.github/templates/csharp-xunit-document.template.md)
...
### Step 5: Generate Unit Test Documentation

#### 5.1 Read Unit Test Document Template
...
- **Encoding**: UTF-8 BOM
- **Same Name File**: If file already exists, add a new log entry change log table
