...
public static class ModuleExtension
{
    ...
    public static void AddApplicationServiceWithAutofac(this WebApplicationBuilder builder)
    {
        ...
        builder.Host.ConfigureContainer<ContainerBuilder>(builder => builder.RegisterModule(new DaoRegisterModule()));
        ...
        builder.Host.ConfigureContainer<ContainerBuilder>(builder => builder.RegisterModule(new ValidatorRegisterModule()));
    }
}
